...
echo -e "set global max_connections = 450;\nquit\n" | (mysql -u root -padmin)
...
glance image-create --name=ubuntu-software-config --is-public=true --disk-format=qcow2 --container-format=bare --file  ../images/ubuntu-software-config.qcow2
glance image-create --name=centos7-software-config-v3 --is-public=true --disk-format=qcow2 --container-format=bare --file  ../images/centos7-software-config-v3.qcow2
source openrc demo demo
#heat stack-create kube-skydns-cluster -f ../heat/kube-cluster.yaml
